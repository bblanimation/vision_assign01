...
% implement my_imfilter.m and then debug it using assign01_test_filtering.m
...
blurredImage2 = my_imfilter(image2, large_1d_blur_filter);
blurredImage2 = my_imfilter(blurredImage2, large_1d_blur_filter'); %notice the ' operator which transposes the filter
